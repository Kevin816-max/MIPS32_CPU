...
# set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports {BTN}]
...
# ²¦Âë¿ª¹Ø
set_property -dict {PACKAGE_PIN P5 IOSTANDARD LVCMOS33} [get_ports {SW[2]}]
set_property -dict {PACKAGE_PIN P4 IOSTANDARD LVCMOS33} [get_ports {SW[1]}]
set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports {SW[0]}]